                    ...
                    <div className="abilities">
                        <div className="abilities__item">
                            <div className='abilities__item--container'>
                                <p className="abilities__speed">Attack: {getPokemon.stats?.[1].base_stat}</p>
                            </div>
                        ...
                        <div className="abilities__item">
                            <div className='abilities__item--container'>
                                <p className="abilities__speed">Defense: {getPokemon.stats?.[2].base_stat}</p>
                            </div>
                        ...
                        <div className="abilities__item">
                            <div className='abilities__item--container'>
                                <p className="abilities__speed">Speed: {getPokemon.stats?.[5].base_stat}</p>
                            </div>
