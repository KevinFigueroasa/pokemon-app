    ...
    return (
        <div className='login'>
            <div className='welcome-trainer'>
                ...
                <img id='poke-master' src="https://images.wikidexcdn.net/mwuploads/esssbwiki/thumb/1/1a/latest/20181107165948/Entrenador_Pok%C3%A9mon_SSBU.png/640px-Entrenador_Pok%C3%A9mon_SSBU.png" alt="" />
            </div>
